...
const redDot = (doc, m, x, y, dx=0,dy=0) => doc.setFillColor(255,0,0).circle(m.px(x,dx), m.py(y,dy), 0.5, 'F');
...
// ! in stead we adjust the x value to pull the start of text to the right
